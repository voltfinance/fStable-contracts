...
subtask("save-deposit", "Deposit to savings contract")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        const saveAddress = resolveAddress(taskArgs.fasset, chain, "savings")
        ...
        await logTxDetails(tx, `deposit ${taskArgs.amount} ${taskArgs.fasset} in Save`)
    })
...
subtask("save-redeem", "Redeems a number of Save credits from a savings contract")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        await logTxDetails(tx, `redeem ${taskArgs.amount} ${taskArgs.fasset} in Save`)
    })
