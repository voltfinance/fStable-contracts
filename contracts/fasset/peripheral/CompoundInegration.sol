...
contract CompoundIntegration is AbstractIntegration {
     ...
     * @param _lp               Address of liquidity provider. eg fAsset or feeder pool
    ...
    ****************************************/
     ...
     *      (fAsset and corresponding BasketManager)
    ...
    function _withdraw(
        ...
        // Reason for skipping: to ensure that redeemFasset is always able to execute
    ...
    ****************************************/
    ...
    function reApproveAllTokens() external onlyGovernor {
        ...
        for (uint256 i = 0; i < bAssetCount; i++) {
            ...
            FassetHelpers.safeInfiniteApprove(bAsset, cToken);
        }
    }
    ...
    function _abstractSetPToken(address _bAsset, address _cToken) internal override {
        ...
        FassetHelpers.safeInfiniteApprove(_bAsset, _cToken);
    }
