...
contract MockSavingsContract is ERC20 {
        ...
        )
    {
        ...
        (creditsBurned, fassetRedeemed) = _redeem(_amount, _isCreditAmt, false);
        require(
            _isCreditAmt ? creditsBurned == _amount : fassetRedeemed == _amount,
            "Invalid output"
        );

        // Approve wrapper to spend contract's underlying; just for this tx
        // underlying.approve(unwrapper, fassetRedeemed);
